...
// Get the modal
// var modal = document.getElementsByClassName("popup-modal"); // Get the button that opens the modal
//
// var btn = document.getElementsByClassName("popup-button"); // Get the <span> element that closes the modal
//
